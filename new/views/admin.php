...
<body>
    <header>
        <nav>
<a href="../index.html" class="logo-text"><span class="initial">Pizza</span>Food</a>
<ul class="menu">
...
<footer class="fo">
    <address>   
        ...
        <ul> 
    <li><a href='https://goo.gl/maps/CPtrU1FHBa2aNyZL9' target='_blank' rel='noopener noreferrer nofollow'>м. Старокостянтинів, Стецьки</a></li>
